...
public class QuizActivity extends AppCompatActivity {
    ...
    private static final long COUNTDOWNIN_MILLIS=30000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String difficulty = intent.getStringExtra(QuizAppActivity.EXTRA_DIFFICULTY);
        int categoryId = intent.getIntExtra(QuizAppActivity.EXTRA_CATEGORY_ID, 0);
        String categoryName = intent.getStringExtra(QuizAppActivity.EXTRA_CATEGORY_NAME);
            ...
            public void onClick(View view) {
                if(!answered)
                {
                    if(rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked())
                    {
                        ...
                        Toast.makeText(QuizActivity.this, "Please selct an asnswer", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                    showNextQuestion();
    ...
    private void showNextQuestion()
    {
        ...
        if(questionCounter<questionCountTotal)
        {
            ...
            timeLeftinMilis=COUNTDOWNIN_MILLIS;
            startCountDown();
    ...
    private void startCountDown()
    {
        countDownTimer=new CountDownTimer(timeLeftinMilis,1000) {
            ...
            public void onFinish() {
                timeLeftinMilis= Long.valueOf(0);
                updateCountDownText();
                checkAnswer();
            }
        }.start();
